...
const Create = () => {
  ...
  const createHandler = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://localhost:7030/api/Diaries", {
        imageUrl: img,
        title: title,
        description: desc,
              ...
              <div className="diaryDesc">
                ...
                <div className="our">
                  <input
                    ...
                    type="text"
                    value={overrated}
                    onChange={(e) => setOverrated(e.target.value)}
                    placeholder="Overrated spots"
                  />
                  <input
                    name="underrated"
                    type="text"
                    value={underrated}
                    onChange={(e) => setUnderrated(e.target.value)}
                    placeholder="Underrated spots"
                  />
                </div>
              </div>
